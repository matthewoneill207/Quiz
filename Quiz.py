...
class Quiz:
    ...
    def Question(self):
        ...
        if len(self.ask) > 0 and self.number < self.Max:
            ...
            clear()
            lb1 = tk.Label(window, text="You got " + str(self.right) + " out of " + str(self.Max) + " correct! If you want to quit, Click the Quit button")
            lb1.grid(column=0,row=0,padx=100,pady=(170,15))
